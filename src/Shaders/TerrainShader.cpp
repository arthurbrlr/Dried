...
namespace Shaders {
    TerrainShader::TerrainShader(const std::string & pathToVertexShader, const std::string & pathToFragmentShader) { // : ShaderProgram(pathToVertexShader, pathToFragmentShader)
